...
<body onload="ram()">
	...
	<form:form method="post" action="submitQuestionList"
		...
		<div class="w3-cantainer" style="padding: 10px 10px">
			...
			<div class="w3-right " width="1px" height="1px">
				<%-- <form name="form1">
				  ...
				  <jsp:include page="TimeTrial.jsp" /> 
			</div>
			<hr>
		</div>
 	...
 	int i = (Integer) session.getAttribute("index");
 		int status = 0;
 %> <core:forEach varStatus="status"
						var="questionPaperCommand"
						...
						<hr>
						&nbsp;&nbsp;&nbsp;&nbsp;<form:radiobutton name="option[<%=i%>]"
							id="op1" path="questionBank[${status.index}].answer"
							value="${questionPaperCommand.option1}" />
							${questionPaperCommand.option1}
							<br>
					&nbsp;&nbsp;&nbsp;&nbsp;<form:radiobutton name="option[<%=i%>]"
							id="op2" path="questionBank[${status.index}].answer"
							value="${questionPaperCommand.option2}" />
							${questionPaperCommand.option2}
				<br>
				&nbsp;&nbsp;&nbsp;&nbsp;<form:radiobutton name="option[<%=i%>]"
							id="op3" path="questionBank[${status.index}].answer"
							value="${questionPaperCommand.option3}" />
							${questionPaperCommand.option3}
				<br>

				&nbsp;&nbsp;&nbsp;&nbsp;<form:radiobutton name="option[<%=i%>]"
							id="op4" path="questionBank[${status.index}].answer"
...
<br>
			...
			<div class="w3-container w3-right">
				<ul class="pagination">
					...
					<li><a onclick="nextOnClick()" class="">Next</a></li>
					<li><a onclick="submitOnClick()" class="">Submit Exam</a></li>
				</ul>
			</div>
			</core:forEach>
			<%-- </core:if> --%>
